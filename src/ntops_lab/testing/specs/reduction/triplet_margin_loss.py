...
from ntops_lab.kernels.reduction.triplet_margin_loss import run
...
def run_pytorch(*inputs):
    ...
    return F.triplet_margin_loss(anchor, positive, negative, margin=1.0, p=2.0, eps=1.0e-6, swap=False, reduction="none")
