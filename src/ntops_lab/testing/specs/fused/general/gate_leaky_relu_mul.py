import torch
from ntops_lab.kernels.fused.general.gate_leaky_relu_mul import run

OP_NAME = "gate_leaky_relu_mul"
...
def run_pytorch(*inputs):
    a, b = inputs
    return torch.nn.functional.leaky_relu(a, negative_slope=0.01) * b
