import torch
from ntops_lab.kernels.fused.general.gate_leaky_relu_add_mul import run

OP_NAME = "gate_leaky_relu_add_mul"
...
def run_pytorch(*inputs):
    a, b, c = inputs
    return torch.nn.functional.leaky_relu(a + b, negative_slope=0.01) * c
