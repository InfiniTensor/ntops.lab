import torch
from ntops_lab.kernels.fused.general.gate_hardsigmoid_add_mul import run

OP_NAME = "gate_hardsigmoid_add_mul"
...
def run_pytorch(*inputs):
    a, b, c = inputs
    value = a
    return (torch.nn.functional.hardsigmoid(value) + c) * b
