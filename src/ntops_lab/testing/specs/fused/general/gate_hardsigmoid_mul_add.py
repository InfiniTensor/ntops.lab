import torch
from ntops_lab.kernels.fused.general.gate_hardsigmoid_mul_add import run

OP_NAME = "gate_hardsigmoid_mul_add"
...
def run_pytorch(*inputs):
    a, b, c = inputs
    value = a
    return (torch.nn.functional.hardsigmoid(value)) * b + c
