import torch
from ntops_lab.kernels.fused.general.add_layer_norm_leaky_relu import run
...
ROWS = 2048
HAS_RESIDUAL = True
OP_NAME = "add_layer_norm_leaky_relu"
...
def run_pytorch(*inputs):
    ...
    value = torch.nn.functional.layer_norm(x + residual, (x.shape[1],), gamma, beta, EPS)
