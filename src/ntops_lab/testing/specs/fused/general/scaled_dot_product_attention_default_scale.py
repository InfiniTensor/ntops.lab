...
from ntops_lab.kernels.fused.general.scaled_dot_product_attention_default_scale import run


OP_NAME = "scaled_dot_product_attention_default_scale"
...
def run_pytorch(*inputs):
    q, k, v = inputs
    return F.scaled_dot_product_attention(q, k, v, attn_mask=None, dropout_p=0.0, is_causal=False, scale=None)
