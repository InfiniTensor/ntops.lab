import torch
from ntops_lab.kernels.fused.general.gate_leaky_relu_mul_add import run

OP_NAME = "gate_leaky_relu_mul_add"
...
def run_pytorch(*inputs):
    a, b, c = inputs
    return torch.nn.functional.leaky_relu(a, negative_slope=0.01) * b + c
