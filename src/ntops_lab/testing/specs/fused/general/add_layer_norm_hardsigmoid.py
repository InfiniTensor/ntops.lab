import torch
from ntops_lab.kernels.fused.general.add_layer_norm_hardsigmoid import run

EPS = 1.0e-5
DEFAULT_HIDDEN = 32
TEST_HIDDENS = (32, 64)
ROWS = 2048
OP_NAME = "add_layer_norm_hardsigmoid"
...
def run_pytorch(*inputs):
    ...
    return torch.nn.functional.hardsigmoid(value)
