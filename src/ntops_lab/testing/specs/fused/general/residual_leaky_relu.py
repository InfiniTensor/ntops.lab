import torch
from ntops_lab.kernels.fused.general.residual_leaky_relu import run

OP_NAME = "residual_leaky_relu"
...
def run_pytorch(*inputs):
    a, b = inputs
    return torch.nn.functional.leaky_relu(a + b, negative_slope=0.01)
