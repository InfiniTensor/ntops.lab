import torch
from ntops_lab.kernels.fused.general.residual_bias_leaky_relu import run

OP_NAME = "residual_bias_leaky_relu"
...
def run_pytorch(*inputs):
    a, b, c = inputs
    return torch.nn.functional.leaky_relu(a + b + c, negative_slope=0.01)
