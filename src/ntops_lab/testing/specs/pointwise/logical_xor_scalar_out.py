import torch
from ntops_lab.kernels.pointwise.logical_xor_scalar_out import run

OP_NAME = "logical_xor_scalar_out"
...
def run_pytorch(*inputs):
    x, = inputs
    return torch.logical_xor(x, torch.ones_like(x, dtype=torch.bool))
