import torch
from ntops_lab.kernels.pointwise.logical_or_scalar_out import run

OP_NAME = "logical_or_scalar_out"
...
def run_pytorch(*inputs):
    x, = inputs
    return torch.logical_or(x, torch.zeros_like(x, dtype=torch.bool))
