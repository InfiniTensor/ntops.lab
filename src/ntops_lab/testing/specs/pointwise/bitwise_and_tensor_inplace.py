import torch
from ntops_lab.kernels.pointwise.bitwise_and_tensor_inplace import run

OP_NAME = "bitwise_and_tensor_"
IMPLEMENTATION_STATUS = "implemented_ninetoothed"

def make_inputs(device="cuda", dtype=torch.float32):
    x = torch.randint(0, 128, (1048576,), device=device, dtype=torch.int32)
    y = torch.randint(0, 128, (1048576,), device=device, dtype=torch.int32)
    return x, y
