...
def application(x, y, out):
    out = ntl.log(ntl.exp(x) + ntl.exp(0.25))

kernel = ninetoothed.make(arrangement, application, (Tensor(1), Tensor(1), Tensor(1)), kernel_name="ntops_lab_logaddexp_scalar_out")
