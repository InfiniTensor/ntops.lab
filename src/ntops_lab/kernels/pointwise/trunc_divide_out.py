...
def application(x, y, out):
    out = ntl.where((x / y) < 0.0, ntl.ceil(x / y), ntl.floor(x / y))

kernel = ninetoothed.make(arrangement, application, (Tensor(1), Tensor(1), Tensor(1)), kernel_name="ntops_lab_trunc_divide_out")
