...
def application(x, y, out):
    out = ntl.where(x == 0.0, 0.0, x * ntl.log(1.0 + y))

kernel = ninetoothed.make(arrangement, application, (Tensor(1), Tensor(1), Tensor(1)), kernel_name="ntops_lab_special_xlog1py_out")
